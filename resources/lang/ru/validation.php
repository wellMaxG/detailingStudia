...
return [
    ...
    */
    ...
    'after' => 'Дата и время записи должны быть после 10:00.',
    'after_or_equal' => 'Значение поля :attribute должно быть датой после или равной :date.',
    // 'after_or_equal' => 'Дата и время записи должны быть в будущем.',
    ...
    'before' => 'Время работы нашего сервиса с 10:00 до 22:00.',
